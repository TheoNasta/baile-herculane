...
export const Activities = () => {
    const { images, images2, background, mapimg } = useStaticQuery(
        graphql`
            query {
                images: allFile(
                    filter: { relativePath: { glob: "activities/*.jpg" } }
                ) {
                    edges {
                        node {
                            name
                ...
                mapimg: file(
                    relativePath: { eq: "homepage/activities-map.png" }
                ) {
                    childImageSharp {
                        fluid {
                            ...GatsbyImageSharpFluid
                        ...
                        <ActivitiesHome>
                            <ContentHolder>
                                <ContentTop>
                                    <Div>
                                        <Heading level="2">
                                            La doar câteva ore de Timișoara și
                                            Craiova, Băile Herculane este locul
                                            perfect pentru a vă relaxa și
                                            reconecta cu natura
                                        </Heading>
