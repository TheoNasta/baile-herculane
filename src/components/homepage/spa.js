...
export const Spa = () => {
    ...
    const handleAnimation = useOnEnterLeaveTransition(
        () => {
            ...
            tl.add(
                TweenMax.to(".SpaFadeInNext", 0.3, { opacity: 1, y: 0 }, 0.8)
            )
            tl.add(
                TweenMax.to(".SpaFadeInNext2", 0.3, { opacity: 1, y: 0 }, 0.8)
            )
            tl.play()
        },
        () => {
    ...
    return (
        <StaticQuery
            query={graphql`
                query {
                    first: file(relativePath: { eq: "homepage/ivatherm.jpg" }) {
                        childImageSharp {
                            fluid {
                    ...
                    second: file(
                        relativePath: { eq: "homepage/water-img.jpg" }
                    ) {
                        childImageSharp {
                            fluid {
                                ...GatsbyImageSharpFluid
            ...
            `}
            render={data => (
                <Controller vertical key="spa-controller">
                            ...
                            return (
                                <SpaHome>
                                    <ContentHolder>
                                        ...
                                        >
                                            "Legenda spune că Hercule, erou in
                                            mitologia greacă, a luptat cu Hydra
                                            chiar în Herculane. După ce s-a
                                            scălat în izvoarele termale
                                            miraculoase, Hercule a câștigat
                                            puteri noi și a învins Hydra.
                                            Fiecare apă termală este unică, noi
                                            credem ca o avem pe cea mai bună. E
                                            pură, ferită de orice poluare urbană
                                            sau industrială și conține elemente
                                            indispensabile pielii."
                                        </Paragraph>
                                        ...
                                        <SpaVideos>
                                                                ...
                                                                >
                                                                    <g filter="url(#filter0_b)">
                                                                        <path
                                                                            fill-rule="evenodd"
                                                                            clip-rule="evenodd"
                                                                            d="M52.5 105C81.495 105 105 81.4949 105 52.5C105 23.5051 81.495 0 52.5 0C23.505 0 0 23.5051 0 52.5C0 81.4949 23.505 105 52.5 105ZM44 32V71.5L67 51L44 32Z"
                                                                            fill="white"
                                                                            fill-opacity="1"
                                                                        />
                                                                    </g>
                                            ...
                                            <SpaVideosRight>
                                                ...
                                                <Paragraph
                                                    ...
                                                    style={{ fontSize: 14 }}
                                                >
                                                    <em>Rucsandra Hurezeanu</em>{" "}
                                                    - despre beneficiile apei de
                                                    la Herculane
                                                </Paragraph>
                                            </SpaVideosRight>
                                        </SpaVideos>
