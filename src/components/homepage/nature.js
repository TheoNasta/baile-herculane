...
export const Nature = () => {
    ...
    return (
        <StaticQuery
            query={graphql`
                query {
                    first: file(relativePath: { eq: "homepage/pin.jpg" }) {
                        childImageSharp {
                            fluid {
                    ...
                    second: file(relativePath: { eq: "homepage/hercule.jpg" }) {
                        childImageSharp {
                            fluid {
                                ...GatsbyImageSharpFluid
                            }
                    ...
                    forth: file(relativePath: { eq: "homepage/fullimg1.jpg" }) {
                        childImageSharp {
                            fluid {
                                ...GatsbyImageSharpFluid
                            }
                                    ...
                                    <ContentHolder>
                                        <ContentLeft>
                                            <Heading
                                                ...
                                                className="NatFadeIn"
                                            >
                                                Pășește pe urmele Împărătesei
                                                Sissi și ale Împăratului Franz
                                                Joseph
                                            </Heading>
                                        ...
                                        <ContentRight>
                                            <Paragraph
                                                style={{}}
                                                className="NatFadeInNext"
                                            >
                                                <b>Aer ionizat</b>
                                                <br />
                                                <br />
                                                Deşi se află la altitudinea de
                                                168 m, în Băile Herculane se
                                                respiră aer ionizat ca la
                                                1500-2000 de metri, comparabil
                                                cu cel din Alpii elveţieni din
                                                staţiunea Davos sau cu aerul de
                                                la cascada Niagara. Acest aer
                                                ionizat negativ (între 2000 şi
                                                6400 de ioni negativi pe cm2)
                                                este generat de cele 20 de
                                                izvoare termominerale, de
                                                cascadele Cernei, dar mai ales
                                                de pădurea de fag, de pin negru
                                                şi vegetaţia de ferigă din zonă.
                                                <br />
                                                <br />
                                                <br />
                                                ...
                                                <br />
                                                <br />
                                                Parcul Naţional „Domogled –
                                                Valea Cernei” este o grădină
                                                botanică în natură. Muntele
                                                Domogled ce se ridică aproape
                                                vertical deasupra staţiunii
                                                oferă o imagine spectaculoasă pe
                                                care din loc în loc se văd
                                                insulele de Pin Negru de Banat.
                                            </Paragraph>
                                        ...
                                        <PowerCover
                                            className="NatFadeInImg3"
                                            style={{ width: "100%" }}
                                        >
                                            <NaturePhoto3
                                                fluid={
                                                    data.forth.childImageSharp
                                                        .fluid
                                                }
                                                alt="Muntii Domogled"
                                            />
